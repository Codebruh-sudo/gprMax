...
.. code-block:: console
    ...
    python -m gprMax toolboxes/Materials/eccosorb_slab.in -o materials_results/eccosorb_slab

The :download:`editable slab example <../../toolboxes/Materials/eccosorb_slab.in>`
