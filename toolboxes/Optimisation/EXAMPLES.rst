...
Copy :download:`waveform_matching.py <../../toolboxes/Optimisation/examples/waveform_matching.py>`
and :download:`reference_waveform.npz <../../toolboxes/Optimisation/examples/reference_waveform.npz>`
to the same folder. The bundled data are synthetic, generated with width 12 mm
and relative permittivity 4. See
:download:`reference notes <../../toolboxes/Optimisation/examples/reference_waveform.md>`.
...
:download:`thin_wire_dipole.py <../../toolboxes/Optimisation/examples/thin_wire_dipole.py>`
...
:download:`rectangular_patch.py <../../toolboxes/Optimisation/examples/rectangular_patch.py>`
...
:download:`patch notes <../../toolboxes/Optimisation/examples/rectangular_patch.md>`.
...
.. figure:: ../../toolboxes/Optimisation/examples/images/patch_comparison.png
...
.. code-block:: python
   ...
   from toolboxes.Optimisation.examples.rectangular_patch import run_example
