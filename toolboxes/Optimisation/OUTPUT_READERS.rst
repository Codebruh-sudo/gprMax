...
.. code-block:: python
   ...
   from toolboxes.Optimisation import read_receiver, read_port
...
.. code-block:: python
   ...
   from toolboxes.Plotting.plot_port import discover_port_outputs, read_port_output
...
That reader lives in ``toolboxes/Plotting/plot_port.py``. Its ``PortData`` contains
...
:download:`inspect_output.py <../../toolboxes/Optimisation/examples/inspect_output.py>`
...
.. code-block:: console
   ...
   python -m toolboxes.Optimisation.examples.inspect_output path/to/output.h5
   python -m toolboxes.Optimisation.examples.inspect_output path/to/output.h5 --group frills
   python -m toolboxes.Optimisation.examples.inspect_output path/to/output.h5 --terminal frills/frill1 --frequency 3.1e9
