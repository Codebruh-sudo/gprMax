...
The user guide lives beside the code in ``toolboxes/Optimisation`` and is included
...
.. code-block:: console
   ...
   cp toolboxes/Optimisation/examples/start_here.py my_optimisation/my_model.py
...
:download:`Copy the starter <../../toolboxes/Optimisation/examples/start_here.py>`.
...
.. code-block:: python
   ...
   from toolboxes.Optimisation import Real, Integer, Categorical
...
.. code-block:: python
   ...
   from toolboxes.Optimisation import simulate
   from toolboxes.Optimisation.examples.start_here import build_model, evaluate
...
.. code-block:: python
   ...
   from toolboxes.Optimisation import optimise
   from toolboxes.Optimisation.examples.start_here import PARAMETERS, build_model, evaluate
...
.. code-block:: python
   ...
   from toolboxes.Optimisation import LocalPool
...
:download:`execution guide <../../toolboxes/Optimisation/execution-and-processing.md>`.
...
.. include:: ../../toolboxes/Optimisation/OPTIMISERS.rst

.. include:: ../../toolboxes/Optimisation/OUTPUT_READERS.rst

.. include:: ../../toolboxes/Optimisation/EXAMPLES.rst

Further reference
-----------------

* :download:`Campaign API <../../toolboxes/Optimisation/CAMPAIGN.rst>`: multiple scenarios, builders and stored records.
* :download:`Code walkthrough <../../toolboxes/Optimisation/CODE_WALKTHROUGH.md>`: follows a candidate from proposal to score.
* :download:`Developer guide <../../toolboxes/Optimisation/DEVELOPER_GUIDE.md>`: module responsibilities and extension points.
* :download:`Adapter contract <../../toolboxes/Optimisation/ADAPTERS.md>`: add another optimiser without changing model code.
