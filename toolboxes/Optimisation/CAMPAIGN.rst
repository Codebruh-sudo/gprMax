...
Activate a working gprMax v4/devel environment. From the repository root::
    ...
    python -m toolboxes.Optimisation.examples.dielectric_block /absolute/path/to/new-campaign
...
Put a top-level function in an importable user module::
    ...
    from toolboxes.Optimisation import PreparedModel
...
Define an importable evaluator in your own module::
    ...
    from toolboxes.Optimisation import ObjectiveResult, read_receiver
...
``ThinWire`` arms separated by a one-cell voltage-source gap::
    ...
    python -m toolboxes.Optimisation.examples.advanced.thin_wire_dipole /absolute/path/to/new-dipole-campaign --target-hz 1e9 --n-trials 12 --optimiser-seed 0
...
evaluator and an explicit frequency tolerance::
    ...
    python -m toolboxes.Optimisation.examples.advanced.thin_wire_dipole /absolute/path/to/new-resonance-campaign --objective resonance --target-hz 1e9 --cycles 100 --frequency-tolerance-hz 1e7 --axial-refinement 2 --radius-m 0.000599584916 --n-trials 24 --optimiser-seed 7 --cpu-threads 4
