...
from toolboxes.Optimisation._storage import write_json
from toolboxes.Optimisation.adapters import OPTIMISERS, make_optimiser
...
def optimise(
    ...
    *,
    ...
    problem = Problem(
        ...
        "toolboxes.Optimisation.examples.advanced.thin_wire_dipole:build_model",
    ...
    result = campaign.optimise(
        optimiser=adapter,
        evaluator="toolboxes.Optimisation.examples.advanced.thin_wire_dipole:"
