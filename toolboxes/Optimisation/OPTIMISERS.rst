...
``python -m pip install -r toolboxes/Optimisation/requirements-optimisers.txt``.
...
:download:`optimiser_choices.py <../../toolboxes/Optimisation/examples/optimiser_choices.py>`
...
.. code-block:: console
   ...
   python -m toolboxes.Optimisation.examples.optimiser_choices results/tpe --optimiser tpe
   python -m toolboxes.Optimisation.examples.optimiser_choices results/rf --optimiser rf
   python -m toolboxes.Optimisation.examples.optimiser_choices results/ga --optimiser ga
   python -m toolboxes.Optimisation.examples.optimiser_choices results/pso --optimiser pso
   python -m toolboxes.Optimisation.examples.optimiser_choices results/de --optimiser de
...
.. code-block:: python
   ...
   from toolboxes.Optimisation import OptunaTPE, SkoptRF, PymooGA, PymooPSO, PymooDE
...
:download:`scipy_integer.py <../../toolboxes/Optimisation/examples/scipy_integer.py>`
uses ``minimise_integer`` to call the same small model at integer permittivities:

.. code-block:: console

   python -m toolboxes.Optimisation.examples.scipy_integer results/scipy
